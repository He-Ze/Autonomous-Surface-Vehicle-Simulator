...
public class ByteStream {
	...
	/**
	 * Stores a boolean as a BYTE within the buffer.
	 * It is a little unoptimized as a boolean is 1 bit
	 * and a byte is 8. However the buffer works in bytes
	 * and it is easier put bytes in.
	 * @param bool
     */
	...
	/**
	 * retrieves a boolean that was stored as a BYTE
	 * within the buffer.
	 * It is a little unoptimized as a boolean is 1 bit
	 * and a byte is 8. However the buffer works in bytes
	 * and it is easier put bytes in.
